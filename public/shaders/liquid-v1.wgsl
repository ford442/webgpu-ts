...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
  ...
  let parallax_time = time * 0.555;
  let base_ambient_strength = 0.0133;
  ...
  let motion_gradient = pow(1.0 - smoothstep(0.0, 0.555, static_depth_for_motion), 2.5);
