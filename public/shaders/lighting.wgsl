    ...
    if (u.mouseDown > 0.5) {
        ...
        if (u.mouse.x > 0.0) {
            ...
            if (depth >= mouse_depth - 0.05) {
                ...
                final_color = vec4(final_color.rgb + vec3<f32>(light_intensity), final_color.a);
            }
        }
    }
